...
public class Config {
    ...
    public static final String ADMIN_PANEL_URL = "https://oltnews.000webhostapp.com/";

    //your api key which obtained from admin panel
    public static final String API_KEY = "cda11jUTWZ0NXFJoArQcxdVD9Ivi324Gg1pe7u6nzYKqRyafMw";
